										...
										<?php foreach ($registrasi as $key) : ?>
											<tr>
												...
												<td class="text-center">
													...
													<button class="btn btn-danger btn-sm mt-1 w-100" data-toggle="modal" data-target="#modalKeuanganBatalKP" data-id_registrasi="<?= $key['id_registrasi'] ?>">
...
<!-- MODAL VIEW KP -->
<div class="modal fade" id="modalKeuanganShowDataKP" tabindex="-1" role="dialog" aria-labelledby="modalKeuanganShowDataKPTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalKeuanganShowDataKPTitle">Data Mahasiswa KP</h5>
			...
			<div class="modal-body">
				...
				<form action="<?php echo base_url('keuangan/verif_keu') ?>" onsubmit="return confirm('Data Akan Diverifikasi?');" method="POST" id="form-setuju">
					<input type="hidden" name="id_registrasi" id="id_registrasi">
					<button type="submit" class="btn btn-success btn-sm" style="width:4rem">
						<i class="fas fa-check"></i>
					</button>
				</form>
				<form action="<?= base_url('keuangan/batal_keu') ?>" class="d-none" id="form-batal" method="POST">
...
<div class="modal fade" id="modalKeuanganBatalKP" role="dialog">
