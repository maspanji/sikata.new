...
<!-- MODAL VIEW KP -->
<div class="modal fade" id="modalKeuanganShowRekapKP" tabindex="-1" role="dialog" aria-labelledby="modalKeuanganShowRekapKPTitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalKeuanganShowRekapKPTitle">Data Mahasiswa KP</h5>
