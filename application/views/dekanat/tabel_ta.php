									...
									<tbody>
										<?php foreach ($registrasi_ta as $key) : ?>
											<tr>
												...
												<td><?php echo $key['nama_mhs'] ?></td>
												<td>
													<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modalDekanatShowDataTA" data-nim="<?= $key['nim_mhs'] ?>" data-nama="<?= $key['nama_mhs'] ?>" data-tahun="<?= $key['tahun'] ?>" data-prodi="<?= $key['nama_prodi'] ?>" data-id_registrasi="<?= $key['id_registrasi'] ?>">
...
<!-- MODAL VIEW TA -->
<div class="modal fade" id="modalDekanatShowDataTA" tabindex="-1" role="dialog" aria-labelledby="modalDekanatShowDataTATitle" aria-hidden="true">
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="modalDekanatShowDataTATitle">Data Mahasiswa TA</h5>
			...
			<div class="modal-body">
				...
				<form action="<?php echo base_url('dekanat/verif_dek_ta') ?>" onsubmit="return confirm('Data Akan Diverifikasi?');" method="POST" id="form-setuju">
